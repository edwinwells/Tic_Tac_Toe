	...
	def get_unbeatable_computer_player_X_move(newgame, player_name)
		...
		# if then O takes an edge, then X must block, and this will force O to block next move:
   		...
   		#or if O misses the block:
   					...
   					"c3" 
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", c1: "O",}
   					"c3" 
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", c2: "O",}
   					"c3" 
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", a2: "O",}
   					"c3" 
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", a3: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", b1: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", c1: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", a2: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", a3: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", b3: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", a2: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", a3: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", b3: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", c2: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", c1: "O",}
   					"c3"
   				elsif newgame.setup >= {a1: "X", a2: "O", b2: "X", c1: "O",}
   					"c3"
   		...
   		#following weakest play by O (cf above,) X wins thru' the fork:
   					...
   					"c2"
   				elsif newgame.setup >= {a1: "X", a2: "O", b2: "X", c3: "O", a3: "X", c1: "O"}
   					"c2"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", c3: "O", a3: "X", c1: "O"}
   					"a2"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", c3: "O", a3: "X", a2: "O"}
   					"c1"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", c3: "O", a3: "X", b3: "O"}
   					"c1"
   				elsif newgame.setup >= {a1: "X", b1: "O", b2: "X", c3: "O", a3: "X", c2: "O"}
   					"c1"
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", c3: "O", a3: "X", c1: "O"}
   					"a2"
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", c3: "O", a3: "X", a2: "O"}
   					"c1"
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", c3: "O", a3: "X", b1: "O"}
   					"c1"
   				elsif newgame.setup >= {a1: "X", b3: "O", b2: "X", c3: "O", a3: "X", c2: "O"}
   					"c1"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", c3: "O", c1: "X", a3: "O"}
   					"b1"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", c3: "O", c1: "X", b1: "O"}
   					"a3"
   				elsif newgame.setup >= {a1: "X", c2: "O", b2: "X", c3: "O", c1: "X", a2: "O"}
   					"b1"
   				elsif newgame.setup >= {a1: "X", b2: "O", c3: "X", c2: "O", a2: "X", b1: "O"}
   					"a3"
   					...
   					"a2"
   				elsif newgame.setup >= {a1: "X", b2: "O", c3: "X", c1: "O", a3: "X", c2: "O"}
   					"b3"
